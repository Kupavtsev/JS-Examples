...
принимать переменное число аргументов или массив в виде аргумента. Кроме
того, он прилагает максимум усилий, чтобы преобразовать нечисловые аргументы
в числа, прежде чем сгенерировать исключение: */
'use strict'
function flexiSum(a) {
    let total = 0;
    for (let i = 0; i < arguments.length; i++) {
        let element = arguments[i];
        if (!element) continue;     // null and undefined ignore
